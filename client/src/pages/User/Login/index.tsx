...
import ScApi from '@/services/ECommerce';
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    try {
      const res = await ScApi.auth.post({ ...values, type });
      if (res.isSuccess === true) {
        localStorage.setItem('token', res?.token);
        // localStorage.setItem(
        //   'menus',
        //   res?.data?.menus !== null ? JSON.stringify(res?.data?.menus) : '',
        // );
            ...
            items={[
              {
                ...
                label: intl.formatMessage({
                  ...
                  defaultMessage: 'A{ccount Password Login',
                }),
              },
              // {
              //   key: 'mobile',
          ...
          {status === 'error' && loginType === 'account' && (
            <LoginMessage
              content={intl.formatMessage({
                ...
                defaultMessage: 'account or password',
              })}
            />
          )}
          {type === 'account' && (
